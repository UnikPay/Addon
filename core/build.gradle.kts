...
dependencies {
    api(project(":api"))
    maven(mavenCentral(), "io.socket:socket.io-client:2.1.1")
    ...
    maven(mavenCentral(), "org.jetbrains.kotlin:kotlin-stdlib:1.9.25")
    maven(mavenCentral(), "com.squareup.okio:okio-jvm:3.9.0")
    maven("https://jitpack.io", "com.github.UnikPay.UnikPay:unikpay-api:1.1.3")
